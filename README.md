...
- The left wizard is controlled by the user, the right one is controlled by the CPU
- The wizards can cast the offensive spell (called "Strikando") to each other
- The wizards can also cast the defensive spell (called "Defendo") which blocks and reflects the opponent's Strikando
- The wizards can also dodge opponent offensive spell by dashing
